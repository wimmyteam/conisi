...
mutate_model_output <- function(df, pop, start_date = NULL, report_lag = 0) {
  ...
  df1 <- df %>%
    dplyr::mutate(r_2d = r_2u,
                  ...
                  AllInfections1 = AllInfections1 + AllInfections1 + AllInfections3,
  ...
  df2 <- df1 %>%
    ...
    dplyr::mutate(AllDailyInfections1 = ContribAll1 - lag(ContribAll1, default = 0),
                  AllDailyInfections2 = ContribAll2 - lag(ContribAll2, default = 0),
                  AllDailyInfections3 = ContribAll3 - lag(ContribAll3, default = 0),
                  AllDailyInfections = ContribAll - lag(ContribAll, default = 0),
                  NonSymptDailyInfections1 = ContribNonSympt1 - lag(ContribNonSympt1, default = 0),
                  NonSymptDailyInfections2 = ContribNonSympt2 - lag(ContribNonSympt2, default = 0),
                  NonSymptDailyInfections3 = ContribNonSympt3 - lag(ContribNonSympt3, default = 0),
                  ...
                  NewCases1 = ConfirmedCases1 - lag(ConfirmedCases1, default = 0),
                  NewCases2 = ConfirmedCases2 - lag(ConfirmedCases2, default = 0),
                  NewCases3 = ConfirmedCases3 - lag(ConfirmedCases3, default = 0),
                  NewCases = ConfirmedCases - lag(ConfirmedCases, default = 0),
                  NewDeaths1 = AllDeaths1 - lag(AllDeaths1, default = 0),
                  ...
                  eta_u_flow1 = eta_u_cumul_flow1 - lag(eta_u_cumul_flow1, default = 0),
                  eta_u_flow2 = eta_u_cumul_flow2 - lag(eta_u_cumul_flow2, default = 0),
                  eta_u_flow3 = eta_u_cumul_flow3 - lag(eta_u_cumul_flow3, default = 0),
                  eta_u_flow = eta_u_cumul_flow - lag(eta_u_cumul_flow, default = 0),
                  r_h_flow1 = r_h_cumul_flow1 - lag(r_h_cumul_flow1, default = 0),
                  r_h_flow2 = r_h_cumul_flow2 - lag(r_h_cumul_flow2, default = 0),
                  r_h_flow3 = r_h_cumul_flow3 - lag(r_h_cumul_flow3, default = 0),
                  r_h_flow = r_h_cumul_flow - lag(r_h_cumul_flow, default = 0),
                  delta_h_flow1 = delta_h_cumul_flow1 - lag(delta_h_cumul_flow1, default = 0),
                  delta_h_flow2 = delta_h_cumul_flow2 - lag(delta_h_cumul_flow2, default = 0),
                  delta_h_flow3 = delta_h_cumul_flow3 - lag(delta_h_cumul_flow3, default = 0),
                  delta_h_flow = delta_h_cumul_flow - lag(delta_h_cumul_flow, default = 0),
                  theta_flow1 = theta_cumul_flow1 - lag(theta_cumul_flow1, default = 0),
                  theta_flow2 = theta_cumul_flow2 - lag(theta_cumul_flow2, default = 0),
                  theta_flow3 = theta_cumul_flow3 - lag(theta_cumul_flow3, default = 0),
                  theta_flow = theta_cumul_flow - lag(theta_cumul_flow, default = 0),
                  Symp_diagnozed_flow1 = Symp_diagnozed_cumul_flow1 - lag(Symp_diagnozed_cumul_flow1, default = 0),
                  Symp_diagnozed_flow2 = Symp_diagnozed_cumul_flow2 - lag(Symp_diagnozed_cumul_flow2, default = 0),
                  Symp_diagnozed_flow3 = Symp_diagnozed_cumul_flow3 - lag(Symp_diagnozed_cumul_flow3, default = 0),
                  Symp_diagnozed_flow = Symp_diagnozed_cumul_flow - lag(Symp_diagnozed_cumul_flow, default = 0),
                  Asymp_diagnozed_flow1 = Asymp_diagnozed_cumul_flow1 - lag(Asymp_diagnozed_cumul_flow1, default = 0),
